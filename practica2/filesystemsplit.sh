...
java -cp $classpath:FileSystemSplit.jar:argparse4j-0.7.0.jar es.loksly.FileSystemSplit -i hdfs:///tmp/filesystemcattest -o hdfs:///tmp/half -p 50 -s 50 --progress y
